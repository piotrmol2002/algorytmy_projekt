...
class MVASolver:
    ...
    def solve(self) -> Dict[str, Any]:
        ...
        - W: Średni czas przebywania zgłoszeń w systemie (waiting time in system)
        ...
        # L - Średnia liczba zgłoszeń w systemie (total number in system)
        # L = suma długości kolejek na wszystkich stacjach
        L = float(np.sum(final_Q))

        # W - Średni czas przebywania zgłoszeń w systemie (waiting time in system)
        # W = średni czas odpowiedzi (czas oczekiwania + obsługi)
